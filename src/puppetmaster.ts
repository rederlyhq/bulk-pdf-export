...
export default class PuppetMaster {
    ...
    static async print(filepath: string) {
        ...
        await page.goto(`http://127.0.0.1:${configurations.server.port}/export/${filepathEnc}.html`, {waitUntil: ['load', 'networkidle0'], timeout: configurations.puppeteer.navigataionTimeout});
